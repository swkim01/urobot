...
public class ContentBrowserAdapter extends BaseAdapter implements
	...
	private void setDirectory(ContentNode containerNode) {
		...
		if (mCurrentRoot.getChildNodes() == null) {
			ActionCallback actionCallback = new Browse(mService, mCurrentRoot.getContainer().getId(), BrowseFlag.DIRECT_CHILDREN) {
	...
	public View getOldView(int position, View convertView, ViewGroup parent) {
		...
		//TextView tvFileName = (TextView) view.findViewById(R.id.content_item_name);
		//vFileName.setText(name);
