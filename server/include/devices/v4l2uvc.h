...
typedef struct _v4l2priv v4l2priv;
struct _v4l2priv {
...
int init_videoIn(struct vdIn *vd, char *device, int width, int height, int fps, int format, int grabmethod, struct urobot_t *ut, struct device_t *dev);
...
int v4l2SetControl(struct vdIn *vd, int control, int value, struct urobot_t *ut, struct device_t *dev);
